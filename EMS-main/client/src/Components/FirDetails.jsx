...
const FIRDetailsPage = () => {
  ...
  const handleTickButtonClick = async () => {
    try {
      ...
      const response = await axios.post(`https://ems-g120-api.vercel.app//tick`, { firid: id });
  ...
  const handleCrossButtonClick = async () => {
    try {
      ...
      const response = await axios.post(`https://ems-g120-api.vercel.app/cross`, { firid: id });
